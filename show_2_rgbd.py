...
if __name__ == '__main__':
    ...
    ### d435i
    #
    #rs_config.enable_stream(rs.stream.infrared, 1, 640, 360, rs.format.z16, frame_rate)
    #rs_config.enable_stream(rs.stream.infrared, 2, 640, 360, rs.format.bgr8, frame_rate)
    # check相机是不是进来了
    connect_device = []
